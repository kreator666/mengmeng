...
from app.api import backtest, bottom_trend_scanner, chain_sentinel, data, factor, fib_levels, markethon, strategy, support_level, v11_strategy_scanner
...
app.include_router(v11_strategy_scanner.router)
